...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('carameluBakery.xml', function(err, result) {
      ...
      result.cafemenu.section[obj.sec_n].entree.push({'prodTitle': obj.item, 'price': obj.price, 'price': description}); //If your XML elements are differet, this is where you have to change to your own element names
